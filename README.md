...
5.  Для повышения привилегий мы изменим содержимое скрипта. Уже знакомым по одному из предыдущих упражнений мы импортируем модуль pty и вызываем с помощью него оболочку shell
